...
uses
  ...
  Vcl.Controls, Vcl.Forms, Vcl.Dialogs, Vcl.ExtCtrls, Vcl.StdCtrls, Vcl.Imaging.jpeg, unVCLPDF, Vcl.Samples.Spin,
...
begin
 ...
 begin
  ...
  if cPageWidthA4/Image1.Picture.Graphic.Width<cPageHeightA4/Image1.Picture.Graphic.Height then
   Scale := cPageWidthA4/Image1.Picture.Graphic.Width/2 else
